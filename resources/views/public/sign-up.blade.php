                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input autocomplete="off" class="input--style-4 js-datepicker" type="text"
                                            name="birthday">
                        ...
                        <div class="row row-space">
                            <div class="col-2" style="position: relative">
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off" id="passwordShow1" class="input--style-4 " type="password" name="password">
                                </div>
                                    <i id="showPass" class="fa-solid fa-eye" onclick="show()"></i>
                                    <i id="hidePass" class="fa-regular fa-eye-slash" onclick="show()"></i>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off" id="passwordShow2" class="input--style-4 " type="password" name="password">
                                </div>
                            </div>
                        </div>
                        {{-- <div class="input-group">
